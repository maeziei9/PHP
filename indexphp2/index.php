...
<p  class="text-bg-info p-3">This output uses include statement in PHP</p>
<p class="text-bg-light p-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis maiores labore temporibus magnam esse. Minus optio dignissimos voluptatum. Facere sequi delectus deleniti aspernatur totam voluptatum perferendis illum repellat adipisci nemo?
...
<a href="./index2.php" class="nav-link active">Go to next Page</a>
