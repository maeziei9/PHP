    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="tel" name="contact_number" placeholder="Enter Contact Number" maxlength="11" pattern="[0-9]{11}"  required />
                </td>
            </tr>
            <tr>
                <td></td>
    ...
    <fieldset style="margin-top: 20px">
        ...
        <table>
            ...
            <tr>
                <td>Gender</td>
                <td>
                    <label for="gender" class="form-label" required></label>
